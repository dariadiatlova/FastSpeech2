...
if __name__ == "__main__":
    ...
    parser.add_argument("--text_grids_directory", type=str, default="/root/dasha/mfa_data/aligned_corpus")
    parser.add_argument("--target_path", type=str, default="/root/dasha/mfa_data/english_phones_mapping.json")
