...
if __name__ == "__main__":
    ...
    parser.add_argument("--text_grids_directory", type=str, default="/root/storage/dasha/data/lj_mfa_data/TextGrids")
    parser.add_argument("--target_path", type=str, default="/root/storage/dasha/data/lj_mfa_data/lj_phones_mapping.json")
