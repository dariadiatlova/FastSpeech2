...
@hydra.main(version_base=None, config_path="config/VCTK", config_name="train_pyw")
def train(cfg) -> None:
    ...
    assert len(synthesis_loader) <= 2, f"Length of val loader: {synthesis_loader}, " \
                                       f"only first 2 batches will be synthesized."
